...
export const Route = createFileRoute("/content")({
  head: () => ({ meta: [{ title: "Content — Verity" }] }),
  component: Page,
});

function Page() {
  return (
    <AppShell title="Content" subtitle="Module in development — full implementation coming next">
      <div className="glass ring-aurora rounded-2xl p-12 flex flex-col items-center justify-center text-center min-h-[60vh]">
        ...
        <h2 className="text-display text-2xl font-semibold mb-2">Content</h2>
