...
export const Route = createFileRoute("/reports")({
  head: () => ({ meta: [{ title: "Reports — Verity" }] }),
  component: Page,
});

function Page() {
  return (
    <AppShell title="Reports" subtitle="Module in development — full implementation coming next">
      <div className="glass ring-aurora rounded-2xl p-12 flex flex-col items-center justify-center text-center min-h-[60vh]">
        ...
        <h2 className="text-display text-2xl font-semibold mb-2">Reports</h2>
